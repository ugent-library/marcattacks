...
program.version(pkg.version)
    ...
    .option('--workers <num>', 'run the map on <num> worker threads; default "auto" = CPU cores - 1 (leaves a core for parsing/I/O). Use 1 to disable. Only parallelizable maps (jsonata, fix) use threads', 'auto')
